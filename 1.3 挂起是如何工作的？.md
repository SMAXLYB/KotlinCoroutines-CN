...
```
## 总结
我希望你现在已经从用户的角度对挂起是如何工作的有了一个清晰的认知，这一点很重要，我们将会看到它(指挂起)贯穿本书，它也是实用的，因为现在你可以把回调函数变成挂起函数。如果你像我一样想知道挂起具体是如何工作的，你可能还然想知道它是如何实现的，如果你对此感到好奇，这些都会在下一章介绍。如果你觉没必要知道，就跳过下一章，毕竟不是特别实用，只是展示了Kotlin协程的魅力。
